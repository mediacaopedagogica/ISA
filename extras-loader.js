...
function wire(){
  ...
  if(isIsa())idle(loadIsaTools,300)
  // Necessário para receber chamadas mesmo sem abrir uma conversa.
  idle(loadCalls,850)

  const chatList=$('chatList')
  if(chatList&&!chatList.dataset.extraLoaderV10){
    chatList.dataset.extraLoaderV10='1'
  ...
  if(chats&&!chats.dataset.extraLoaderV10){
    chats.dataset.extraLoaderV10='1'
  ...
  if(supervision&&!supervision.dataset.extraLoaderV10){
    supervision.dataset.extraLoaderV10='1'
