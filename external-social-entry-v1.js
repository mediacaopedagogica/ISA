...
function enhanceLater(){
  ...
  setTimeout(async()=>{
    ...
    await safe('./nossa-rede-policy-v5-loader.js?v=8-compact-composer');window.__ISA_NOSSA_REDE_V5__?.patch?.()
    safe('./nuvem-compose-compact-v1.js?v=2-compact-3d').then(()=>window.__ISA_NUVEM_COMPACT_COMPOSER__?.scan?.())
