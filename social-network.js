...
function injectUi(){
  if($('socialNav'))return
  const css=document.createElement('link');css.rel='stylesheet';css.href='./social-network.css?v=1';document.head.appendChild(css)
