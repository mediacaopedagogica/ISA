/* Nuvem pin picker v3 — seletor visual sem observar mudanças de classe/título. */
(function(){
  if(window.__NUVEM_PIN_PICKER_V3__)return;window.__NUVEM_PIN_PICKER_V3__=true;
  ...
  function css(){if(document.getElementById('nuvemPinPickerCss'))return;const l=document.createElement('link');l.id='nuvemPinPickerCss';l.rel='stylesheet';l.href='./nuvem-pin-picker-v1.css?v=3-stable';document.head.appendChild(l)}
  ...
  scan();[900,1800,3200].forEach(ms=>setTimeout(scan,ms));
  document.addEventListener('isa:chat-opened',scan,{passive:true});
