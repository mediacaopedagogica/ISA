...
if(!approvedAtBoot){
  ...
  later(20,'./profile-menu-guard.js?v=10-feature-pause',()=>window.__ISA_ENSURE_PROFILE_MENU__?.())
...
later(640,'./family-social-extras-v1.js?v=4-egress-cache',()=>window.__ISA_FAMILY_SOCIAL_EXTRAS__?.scan?.(true))
...
later(705,'./keise-conversation-router-v2.js?v=4-selected-id-lock')
later(710,'./conversation-important-v2.js?v=5-collab-chat-v2',()=>window.__ISA_IMPORTANT_BOARD__?.render?.())
later(716,'./conversation-important-singleton-v1.js?v=1-one-official',()=>window.__ISA_IMPORTANT_SINGLETON__?.scan?.())
...
later(745,'./family-group-stability-v1.js?v=1-familia-stable',()=>window.__ISA_FAMILY_GROUP_STABILITY__?.protect?.())
if(approvedAtBoot)later(752,'./family-board-v1.js?v=1-family-group-board',()=>window.__ISA_FAMILY_BOARD__?.scan?.())
if(!approvedAtBoot)later(760,'./social-nav-guard.js?v=12-social-paused',()=>{window.__ISA_ENSURE_SOCIAL_NAV__?.();window.__ISA_ENSURE_PROFILE_MENU__?.();window.__ISA_PERSONAL_NAV_SYNC__?.()})
...
later(920,'./nossa-rede-policy-v5-loader.js?v=16-comment-isolated',()=>{window.__ISA_NOSSA_REDE_V5__?.patch?.();window.__ISA_COMMENT_MEDIA_MENU__?.scan?.();window.__ISA_NUVEM_COMPACT_COMPOSER__?.scan?.();window.__ISA_SOCIAL_EMOJI_SUITE__?.scan?.();window.__ISA_NOSSA_REDE_MEDIA_WORKFLOW__?.scan?.()})
...
later(995,'./nossa-rede-media-workflow-v4.js?v=4-egress-cache',()=>window.__ISA_NOSSA_REDE_MEDIA_WORKFLOW__?.scan?.())
later(1002,'./nossa-rede-editor-make-addon-v1.js?v=1-makeup-tools',()=>window.__ISA_PATCH_MEDIA_MAKE__?.())
later(1010,'./social-profile-pages-v1.js?v=6-egress-cache',()=>window.__ISA_SOCIAL_PROFILE_PAGES__?.decorate?.())
later(1060,'./social-profile-directory-v1.js?v=4-egress-cache',()=>window.__ISA_SOCIAL_PROFILE_DIRECTORY__?.patch?.())
...
later(1715,'./daily-task-board-ui-fix-v2.js?v=1-no-overlap-actions',()=>window.__ISA_DAILY_TASK_BOARD_UI_FIX_V2__?.scan?.())
...
later(2335,'./nossa-rede-media-workflow-v4.js?v=4-egress-cache',()=>window.__ISA_NOSSA_REDE_MEDIA_WORKFLOW__?.scan?.())
