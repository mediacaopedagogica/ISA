...
if(!document.getElementById('nuvemReferenceFinalV1')){const l=document.createElement('link');l.id='nuvemReferenceFinalV1';l.rel='stylesheet';l.href='./nuvem-reference-final-v1.css?v=1-approved-reference';document.head.appendChild(l)}
