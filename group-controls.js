...
setInterval(()=>{const id=activeId();if(id!==lastConv){lastConv=id;syncButton()}},550)
document.querySelector('[data-tab="chats"]')?.addEventListener('click',()=>setTimeout(syncButton,120))
