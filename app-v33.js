...
// The old bundled app duplicated the startup path. This file now delegates to exactly one audited core.
(function(){
  'use strict'
  ...
  window.__ISA_APP_ENTRY_PROMISE__=import('./app-core-single-v1.js?v=2-single-core-live')
    ...
    .catch(error=>{
      ...
      if(detail)detail.textContent='Atualize a página e tente novamente.'
