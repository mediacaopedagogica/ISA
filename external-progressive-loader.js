...
function start(){
  ...
  later(165,'./collaborative-chat-postits-v1.js?v=1-edit-drag-status',()=>window.__ISA_COLLAB_POSTITS__?.scan?.())
  ...
  setTimeout(()=>{window.__ISA_COLLAB_POSTITS__?.scan?.();window.__ISA_SOCIAL_EMOJI_SUITE__?.scan?.();window.__ISA_FAMILY_SOCIAL_EXTRAS__?.scan?.(true);window.__ISA_NOSSA_REDE_BIRTHDAYS__?.refresh?.()},2330)
