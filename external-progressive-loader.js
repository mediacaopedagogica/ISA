...
function start(){
  ...
  later(1050,'./nossa-rede-media-workflow-v3.js?v=1-rich-editor',()=>window.__ISA_NOSSA_REDE_MEDIA_WORKFLOW__?.scan?.())
  ...
  later(2170,'./nossa-rede-media-workflow-v3.js?v=1-rich-editor',()=>window.__ISA_NOSSA_REDE_MEDIA_WORKFLOW__?.scan?.())
